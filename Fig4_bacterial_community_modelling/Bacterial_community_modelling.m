...
modPath = '/Users/jinyi/Documents/.../Low_community_exclude'
%% model list name
% gut
[~,infoFile,~]=xlsread('/Users/jinyi/Documents/.../Average_Low_SampleID_exclude.xlsx');
...
% gut
saveDir = '/Users/jinyi/Documents/.../simu_out';
cd(saveDir)

%% load diet table

% use model derived diet
dietpath = '/Users/jinyi/Documents/.../modelDerivedDiet_community.xlsx';
...
writetable(join_withoutO2, [saveDir filesep 'Top15_exc_add16_LC_High_OGD_avg_240924.xlsx']);
...
writetable(filteredTable, [saveDir filesep 'FeEx_Top15_exc_add16_LC_Low_OGD_avg.xlsx']);
