reactobiome_frommsp_gut_lc_and_h
reactobiome_frommsp_oral_lc_and_h
...
load("dmnallgut.RData") # dmnalloral.RData for oral dmn result
...
write_xlsx(df_save, "table_out/Overall_diff_gut_40.xlsx")

df_full_save = df_full %>% as.data.frame()
df_full_save$Rxn = rownames(df_full_save)
write_xlsx(df_full_save, "table_out/Overall_diff_gut_full.xlsx")
...
write_xlsx(df_o_save, "~/Documents/Reactotype_2024_new/ReDo_Reto_typing/table_out/Overall_diff_oral_40.xlsx")

df_full_o_save = df_full_o %>% as.data.frame()
df_full_o_save$Rxn = rownames(df_full_o_save)
write_xlsx(df_full_o_save, "~/Documents/Reactotype_2024_new/ReDo_Reto_typing/table_out/Overall_diff_oral_full.xlsx")


# write.csv(df_o,"table_out/Overall_diff_oral_40.csv",row.names = T)
# write.csv(df_full_o,"table_out/Overall_diff_oral_full.csv",row.names = T)
...
write_xlsx(df_1_save, "table_out/diff_gut_R1.xlsx")

df_2_save = df_2 %>% as.data.frame()
df_2_save$Rxn = rownames(df_2_save)
write_xlsx(df_2_save, "table_out/diff_gut_R2.xlsx")

df_3_save = df_3 %>% as.data.frame()
df_3_save$Rxn = rownames(df_3_save)
write_xlsx(df_3_save, "table_out/diff_gut_R3.xlsx")

# oral
df_1_o_save = df_1_o %>% as.data.frame()
df_1_o_save$Rxn = rownames(df_1_o_save)
write_xlsx(df_1_o_save, "table_out/diff_oral_R1.xlsx")

df_2_o_save = df_2_o %>% as.data.frame()
df_2_o_save$Rxn = rownames(df_2_o_save)
write_xlsx(df_2_o_save, "table_out/diff_oral_R2.xlsx")


###############################
# load metadata for samples
library(readxl)
lcgutrxtotype_metadata 
loralcrxtotype_metadata 
allgutrxtotype_metadata 
alloralrxtotype_metadata 
...
# $Healthy[1] 56 $`Mild Severity`[1] 16  
...
library(writexl)
write_xlsx(oral.rxty.pcoa.tab, "table_out/oral.rxty.pcoa.tab.xlsx")
write_xlsx(gut.rxty.pcoa.tab, "table_out/gut.rxty.pcoa.tab.xlsx")
